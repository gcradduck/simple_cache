...
time_left(_StartTime, infinity) ->
    infinity;
time_left(StartTimeSeconds, LeaseTimeSeconds) ->
    ElapsedSeconds = getNowSeconds() - StartTimeSeconds,
    case (LeaseTimeSeconds - ElapsedSeconds) of
        SecondsLeft when SecondsLeft =< 0 ->
            0;
